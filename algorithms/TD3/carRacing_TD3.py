...
class RewardCallback(BaseCallback):
    ...
    def _on_training_end(self) -> None:
        ...
        save_path = 'csv/td3_reward_vs_timesteps.csv'
...
model = TD3('CnnPolicy', vec_env, verbose=1, buffer_size=1000, tensorboard_log="./td3_car_racing_tb/")
reward_callback = RewardCallback()
model.learn(total_timesteps=50_000, callback=reward_callback)

# 3) Simpan model setelah training
# model.save("td3_car_racing_trained")

model_save_dir = 'models'
model_base_name = 'td3_car_racing_vec'
...
print(f"\n✅ Model TD3 disimpan di {model_filepath}")
...
metrics_save_path = 'csv/td3_metrics_performance.csv'
